...
const page = {
    ...
    header: {
        h1: document.querySelector('.main_h'),
        progressPercent: document.querySelector('.progress_percent'),
        progressCoverBar: document.querySelector('.progress_bar_cover_bar'),
...
function setIcon(context, icon) {
    ...
    const activeIcon = document.querySelector('.icon_popup.icon_active');
